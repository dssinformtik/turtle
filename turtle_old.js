...
var y=20,al=Math.acos((b*b+c*c-a*a)/(2*b*c))*180/pi, 		//	a^2=b^2+c^2-2bc cos(al)
	...
	if(a==0||b==0||c==0) alert("sorry, das kann ich noch nicht"); else
...
if(!al) al=0;if(!be) be=0;if(!ga) ga=0;if(!s) s=100; // nur wegen s
a=Number(a); b=Number(b); c=Number(c); al=Number(al); be=Number(be); ga=Number(ga);
var a2=0,b2=0,c2=0,al2=0,be2=0,ga2=0;
//sws
...
if(a!=""||b!=""||c!=""){zeichne(1); dreieck(a,b,c,al,be,ga, s); } // 0,6,7, 20

// dreieck(0,6,4, 0,0,40, 50); // dreieck(0,6,5, 30,0,0); ges: beta
